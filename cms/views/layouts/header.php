            ...
            <div class="sidebar-content">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li><a href="hizmetler" class="<?php if($activeClass=="hizmetler"){echo "active";} ?>"><i class="si si-briefcase"></i><span class="sidebar-mini-hide">Hizmetler Yönetimi</span></a></li>
                        ...
                        <li class="<?php if($activeClass=="hizmetkategori" OR $activeClass=="hizmetaltkategori" OR $activeClass=="hizmet"){echo "open";} ?>">
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">Hizmet Yönetimi</span></a>
                            <ul>
                                <li><a class="<?php if($activeClass=="hizmet"){echo "active";} ?>"href="hizmet">Hizmetler</a></li>
                                <li><a class="<?php if($activeClass=="hizmetkategori"){echo "active";} ?>" href="hizmet-kategori">Kategori Yönetimi</a></li>
                        ...
                        <li>
                            <a href="kullanici-yorumlari" class="<?php if($activeClass=="yorumlar"){echo "active";} ?>"><i class="si si-bubbles"></i><span class="sidebar-mini-hide">Kullanıcı Yorumları</span></a>
                        </li>
