...
$activeClass ="hizmetaltkategori";
$pageTitle = "Maharethane - Hizmetler Alt Kategori Yönetimi";
include('layouts/header.php');
include('../operations/middleware/AuthorizationMiddleware.php');
$perform = $_GET['perform'];
$contentID = $_GET['id'];
$controllerName="hizmetAltKategori";
?>
...
<main id="main-container">
    ...
    <div class="content">
        <div class="block block-transparent bg-video" data-vide-bg="assets/media/videos/city_night" data-vide-options="posterType: jpg" style="position: relative;"><div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-color: transparent; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;"><video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; opacity: 1; width: 1154px; height: auto;"><source src="assets/media/videos/city_night.mp4" type="video/mp4"><source src="assets/media/videos/city_night.webm" type="video/webm"><source src="assets/media/videos/city_night.ogv" type="video/ogg"></video></div>
            <div class="block-content bg-primary-dark-op">
                <div class="py-20 text-center">
                    <h1 class="font-w700 text-white mb-10">Hizmetler Alt Kategori Yönetimi</h1>
                    <h2 class="h4 font-w400 text-white-op">Sistemde bulunan ve sisteme eklenecek hizmet alt kategorilerini bu alandan yönetebilirsiniz.</h2>
                </div>
            </div>
        </div>
                    ...
                    <table id="sort" class="table table-bordered table-striped table-vcenter js-dataTable-full background-white">
                        <thead>
                            <tr>
                                ...
                                <th class=" d-none d-lg-table-cell">Son Değişiklik Tarihi</th>
                        ...
                        <tbody id="sortItems">
                            ...
                            $pageData = $db->prepare("SELECT tbl_hizmet_alt_kategori.*, tbl_hizmet_kategori.adi_tr as kategori_adi FROM tbl_hizmet_alt_kategori LEFT JOIN tbl_hizmet_kategori ON tbl_hizmet_alt_kategori.kategori_id = tbl_hizmet_kategori.id ORDER BY tbl_hizmet_alt_kategori.sira");
                            ...
                            while ($getData = $pageData->fetch(PDO::FETCH_ASSOC)) { ?>
                                ...
                                <tr data-id="<?= $getData['id']?>">
                                    <td class="font-w600  text-center d-none d-lg-table-cell">
                                    ...
                                    <td class="font-w600 d-none d-sm-table-cell"><span class="badge  <?php if($getData['durum']==1){echo "badge-info";}elseif($getData['durum']==0){echo "badge-danger";} ?>"><?php if($getData['durum']==1){echo "Aktif";}elseif($getData['durum']==0){echo "Pasif";} ?></span></td>
                                    <td class="font-w600 d-none d-lg-table-cell"><?= $getData['tarih']?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="../operations/controllers/hizmetAltKategoriController?perform=delete&id=<?= $getData["id"]; ?>&adi=<?= $getData["adi_tr"]; ?>" onclick="return confirm('<?= $getData['adi_tr']; ?> Adlı Kaydı Silmek İstediğinize Eminmisiniz? ')">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <?php if ($turkish == "on") { ?>
                            <div class="tab-pane active" id="turkce" role="tabpanel">
                                <form action="../operations/controllers/hizmetAltKategoriController" method="post" name="addPage"  enctype="multipart/form-data">
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                        <div class="block-options">
                            <div class="block-options-item">
                                ...
                                <a href="hizmet-alt-kategori"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                            </div>
                        </div>
                    </div>
                    </form>
        ...
        if ($perform == "edit") {
            ...
            $getContent = $db->prepare("SELECT * FROM tbl_hizmet_alt_kategori WHERE id=?");
        ...
        <div class="block block-fx-shadow">
            <div class="block">
                ...
                <div class="block-content tab-content">
                    ...
                    <?php if ($turkish == "on") { ?>
                        <div class="tab-pane active" id="turkce" role="tabpanel">
                            <form action="../operations/controllers/hizmetAltKategoriController" method="post" name="customer" id="cpr" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="col-6">
                                        <label class="css-control css-control-warning css-switch">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                    <div class="block-options">
                        <div class="block-options-item">
                            ...
                            <a href="hizmet-alt-kategori?statu=ok"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                        </div>
                    </div>
                </div>
                </form>
