...
$authPageName = "page";
$activeClass ="cozumler";
$pageTitle = "Maharethane - Çözümler Yönetimi";
include('layouts/header.php');
include('../operations/middleware/AuthorizationMiddleware.php');
$perform = $_GET['perform'];
$contentID = $_GET['id'];
$controllerName="cozumler";
...
<script type="text/javascript">
    ...
    function ajax_file_upload(file_obj) {
        if (file_obj != undefined) {
            ...
            form_data.append('pageName', 'cozumler');
            form_data.append('performName', 'Çözümler sayfa yönetimi');
        ...
        <div class="block block-transparent bg-video" data-vide-bg="assets/media/videos/city_night" data-vide-options="posterType: jpg" style="position: relative;"><div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-color: transparent; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;"><video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; opacity: 1; width: 1154px; height: auto;"><source src="assets/media/videos/city_night.mp4" type="video/mp4"><source src="assets/media/videos/city_night.webm" type="video/webm"><source src="assets/media/videos/city_night.ogv" type="video/ogg"></video></div>
            <div class="block-content bg-primary-dark-op">
                <div class="py-20 text-center">
                    <h1 class="font-w700 text-white mb-10">Çözümler Sayfa Yönetimi</h1>
                    <h2 class="h4 font-w400 text-white-op">Çözümler sayfası içeriklerini bu alandan yönetebilirsiniz.</h2>
                </div>
            </div>
        </div>
        <?php
                ...
                <div class="block-content block-content-full">
                    ...
                    <table id="sort" class="table table-bordered table-striped table-vcenter js-dataTable-full background-white">
                        ...
                        <tbody id="sortItems">
                            ...
                            $pageData = $db->prepare("SELECT * FROM tbl_sayfa WHERE cozumler=? ORDER BY sira ASC");
                            $pageData->execute([1]);
                                ...
                                <tr data-id="<?= $getData['id']?>">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="?perform=foto&id=<?= $getData["id"] ?>&pageName=cozumler"><button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Galeri" data-placement="bottom">
                                                    <i class="fa fa-photo"></i>
                                                </button></a>
                                            <a href="../operations/controllers/cozumlerController?perform=delete&id=<?= $getData["id"]; ?>&adi=<?= $getData["adi_tr"]; ?>" onclick="return confirm('<?= $getData['adi_tr']; ?> Adlı Kaydı Silmek İstediğinize Eminmisiniz? ')">
                ...
                <div class="block">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <?php if ($turkish == "on") { ?>
                            <div class="tab-pane active" id="turkce" role="tabpanel">
                                <form action="../operations/controllers/cozumlerController" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="example-hf-email" name="adi_tr" placeholder="Lütfen Doldurun" oninvalid="invalidFunction(event, 'Lütfen içerik alanlarını doldurunuz.')" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                        <div class="col-lg-10">
                                            <textarea class="js-summernote" id="example-textarea-input" name="aciklama_tr" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="example-hf-email" name="desc_tr" placeholder="Lütfen Doldurun" r>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="example-hf-email" name="etiket_tr" placeholder="Lütfen Doldurun">
                                        </div>
                                    </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($english == "on") { ?>
                            <div class="tab-pane >" id="ingilizce" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="adi_en" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                    <div class="col-lg-10">
                                        <textarea class="js-summernote" id="example-textarea-input" name="aciklama_en" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="desc_en" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="etiket_en" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($spanish == "on") { ?>
                            <div class="tab-pane >" id="ispanyolca" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="adi_es" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                    <div class="col-lg-10">
                                        <textarea class="js-summernote" id="example-textarea-input" name="aciklama_es" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="desc_es" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="etiket_es" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($french == "on") { ?>
                            <div class="tab-pane >" id="fransizca" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="adi_fr" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                    <div class="col-lg-10">
                                        <textarea class="js-summernote" id="example-textarea-input" name="aciklama_fr" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="desc_fr" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="etiket_fr" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($arabic == "on") { ?>
                            <div class="tab-pane >" id="arapca" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                    <div class="col-lg-10">
                                        <textarea class="js-summernote" id="example-textarea-input" name="aciklama_ar" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="desc_ar" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="etiket_ar" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                        <div class="block-options">
                            ...
                            <a href="cozumler"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                            </div>
                        </div>
                    </div>
                    </form>
        ...
        <div class="block block-fx-shadow">
            <div class="block">
                ...
                <div class="block-content tab-content">
                    ...
                    <?php if ($turkish == "on") { ?>
                        <div class="tab-pane active" id="turkce" role="tabpanel">
                            <form action="../operations/controllers/cozumlerController" method="post" name="customer" id="cpr" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="col-6">
                                        <label class="css-control css-control-warning css-switch">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" name="adi_tr" placeholder="Lütfen Doldurun" value="<?= $result['adi_tr']; ?>" required="">
                                        <input type="hidden" class="form-control" id="example-hf-email" name="id" placeholder="Lütfen Doldurun" value="<?= $result['id']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik
                                </label>
                                    <div class="col-lg-10">
                                        <textarea class="js-summernote" id="example-textarea-input" name="aciklama_tr" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_tr']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" value="<?= $result['desc_tr']; ?>" name="desc_tr" placeholder="Lütfen Doldurun" r>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="example-hf-email" value="<?= $result['etiket_tr']; ?>" name="etiket_tr" placeholder="Lütfen Doldurun">
                                    </div>
                                </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($english == "on") { ?>
                        <div class="tab-pane <?php if ($turkish != "on") { echo  "active"; } ?>" id="ingilizce" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="adi_en" value="<?= $result['adi_en']; ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                <div class="col-lg-10">
                                    <textarea class="js-summernote" id="example-textarea-input" name="aciklama_en" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_en']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="desc_en" value="<?= $result['desc_en']; ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="etiket_en" value="<?= $result['etiket_en']; ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($spanish == "on") { ?>
                        <div class="tab-pane " id="ispanyolca" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="adi_es" placeholder="Lütfen Doldurun" value="<?= $result['adi_es'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                <div class="col-lg-10">
                                    <textarea class="js-summernote" id="example-textarea-input" name="aciklama_es" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_es'] ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="desc_es" value="<?= $result['desc_es'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="etiket_es" value="<?= $result['etiket_es'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($french == "on") { ?>
                        <div class="tab-pane" id="fransizca" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Başlık</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="adi_fr" value="<?= $result['adi_fr'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                <div class="col-lg-10">
                                    <textarea class="js-summernote" id="example-textarea-input" name="aciklama_fr" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_fr'] ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="desc_fr" value="<?= $result['desc_fr'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="etiket_fr" value="<?= $result['etiket_fr'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($arabic == "on") { ?>
                        <div class="tab-pane" id="arapca" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">İçerik</label>
                                <div class="col-lg-10">
                                    <textarea class="js-summernote" id="example-textarea-input" name="aciklama_ar" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_ar'] ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Kısa Açıklama</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="desc_ar" value="<?= $result['desc_ar'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-hf-email">Etiketler</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="example-hf-email" name="etiket_ar" value="<?= $result['etiket_ar'] ?>" placeholder="Lütfen Doldurun">
                                </div>
                            </div>
                        </div>
                    <?php } ?>
        ...
        <div class="block block-fx-shadow">
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <a href="cozumler"> <button class="btn btn-sm btn-hero btn-outline-secondary"> GERİ DÖN</button></a>
                    </div>
                </div>
                    ...
                    <div class="options-container fx-item-zoom-in fx-overlay-zoom-in" style=" height: 200px; background-image: url(../../uploads/<?= $result["gorsel"] ?>); background-size: cover;">
                        <div class="options-overlay bg-black-op">
                            <div class="options-overlay-content">
                                <a class="btn btn-sm btn-rounded btn-alt-danger min-width-75" href="../operations/controllers/imageUploadController?perform=deleteImage&id=<?= $result["id"]?>&contentID=<?= $result["icerik_id"] ?>&pageName=cozumler">
