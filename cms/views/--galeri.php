...
$activeClass ="gallery";
$pageTitle = "Maharethane - Galeri Yönetimi";
...
<script type="text/javascript">
    ...
    function ajax_file_upload(file_obj) {
        if (file_obj != undefined) {
            ...
            form_data.append('pageName', 'galeri');
            form_data.append('performName', 'Galeri yönetimi');
        ...
        <div class="block block-transparent bg-video" data-vide-bg="assets/media/videos/city_night" data-vide-options="posterType: jpg" style="position: relative;"><div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-color: transparent; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;"><video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; opacity: 1; width: 1154px; height: auto;"><source src="assets/media/videos/city_night.mp4" type="video/mp4"><source src="assets/media/videos/city_night.webm" type="video/webm"><source src="assets/media/videos/city_night.ogv" type="video/ogg"></video></div>
            <div class="block-content bg-primary-dark-op">
                <div class="py-20 text-center">
                    <h1 class="font-w700 text-white mb-10">Galeri Yönetimi</h1>
                    <h2 class="h4 font-w400 text-white-op">Galeri içeriklerini bu alandan yönetebilirsiniz.</h2>
                </div>
            </div>
        </div>
        <?php
                ...
                <div class="block-content block-content-full">
                    ...
                    <table id="sort" class="table table-bordered table-striped table-vcenter js-dataTable-full background-white">
                        ...
                        <tbody id="sortItems">
                            ...
                            $pageData = $db->prepare("SELECT * FROM tbl_sayfa WHERE galeri=1 ORDER BY sira ASC");
                            $pageData->execute();
                                ...
                                <tr data-id="<?= $getData['id']?>">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="?perform=foto&id=<?= $getData["id"] ?>&pageName=galeri"><button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Galeri" data-placement="bottom">
                                                    <i class="fa fa-photo"></i>
                                                </button></a>
                                            <a href="../operations/controllers/galleryController?perform=delete&id=<?= $getData["id"]; ?>&adi=<?= $getData["adi_tr"]; ?>" onclick="return confirm('<?= $getData['adi_tr']; ?> Adlı Kaydı Silmek İstediğinize Eminmisiniz? ')">
                ...
                <div class="block">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <?php if ($turkish == "on") { ?>
                            <div class="tab-pane active" id="turkce" role="tabpanel">
                                <form action="../operations/controllers/galleryController" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-5">
                                <label class="css-control css-control-warning css-switch">
                                    ...
                                    <span class="css-control-indicator"></span> Galeri Aktif
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                        <div class="block-options">
                            ...
                            <a href="galeri"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                            </div>
                        </div>
                    </div>
                    </form>
                        ...
                        <?php if ($english == "on") { ?>
                            <div class="tab-pane" id="ingilizce" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Başlık</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="adi_en" placeholder="Lütfen Doldurun" value="<?= $result['adi_en']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">İçerik</label>
        ...
        <div class="block block-fx-shadow">
            <div class="block">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <a href="galeri"> <button class="btn btn-sm btn-hero btn-outline-secondary"> GERİ DÖN</button></a>
                    </div>
                </div>
                    ...
                    <div class="options-container fx-item-zoom-in fx-overlay-zoom-in" style=" height: 200px; background-image: url(../../uploads/<?= $result["gorsel"] ?>); background-size: cover;">
                        <div class="options-overlay bg-black-op">
                            <div class="options-overlay-content">
                                <a class="btn btn-sm btn-rounded btn-alt-danger min-width-75" href="../operations/controllers/imageUploadController?perform=deleteImage&id=<?= $result["id"]?>&contentID=<?= $result["icerik_id"] ?>&pageName=galeri">
