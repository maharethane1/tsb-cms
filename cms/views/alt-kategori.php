...
$activeClass ="altkategoriler";
$pageTitle = "Maharethane - Alt Kategori Yönetimi";
include('layouts/header.php');
include('../operations/middleware/AuthorizationMiddleware.php');
$perform = $_GET['perform'];
$contentID = $_GET['id'];
$controllerName="altkategori";
...
<main id="main-container">
    ...
    <div class="content">
        <div class="block block-transparent bg-video" data-vide-bg="assets/media/videos/city_night" data-vide-options="posterType: jpg" style="position: relative;"><div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-color: transparent; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;"><video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; opacity: 1; width: 1154px; height: auto;"><source src="assets/media/videos/city_night.mp4" type="video/mp4"><source src="assets/media/videos/city_night.webm" type="video/webm"><source src="assets/media/videos/city_night.ogv" type="video/ogg"></video></div>
            <div class="block-content bg-primary-dark-op">
                <div class="py-20 text-center">
                    <h1 class="font-w700 text-white mb-10">Alt Kategori Yönetimi</h1>
                    <h2 class="h4 font-w400 text-white-op">Sistemde bulunan ve sisteme eklenecek kategorileri bu alandan ekleyip düzenleyebilirsiniz.</h2>
                </div>
            </div>
        </div>
        <?php
                ...
                <div class="block-content block-content-full">
                    ...
                    <table id="sort" class="table table-bordered table-striped table-vcenter js-dataTable-full background-white">
                        ...
                        <tbody id="sortItems">
                            ...
                            $pageData = $db->prepare("SELECT tbl_alt_kategori.*, tbl_ana_kategori.adi_tr as kategori_adi FROM tbl_alt_kategori JOIN tbl_ana_kategori ON tbl_alt_kategori.kategori_id = tbl_ana_kategori.id ORDER BY tbl_alt_kategori.sira");
                            ...
                            while ($getData = $pageData->fetch(PDO::FETCH_ASSOC)) { ?>
                                ...
                                <tr data-id="<?= $getData['id']?>">
                                    ...
                                    <td class="font-w600"><?= $getData['kategori_adi']?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="../operations/controllers/altkategoriController?perform=delete&id=<?= $getData["id"]; ?>&adi=<?= $getData["adi_tr"]; ?>" onclick="return confirm('<?= $getData['adi_tr']; ?> Adlı Kaydı Silmek İstediğinize Eminmisiniz? ')">
                ...
                <div class="block">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <?php if ($turkish == "on") { ?>
                            <div class="tab-pane active" id="turkce" role="tabpanel">
                                <form action="../operations/controllers/altkategoriController" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="aciklama_tr" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                        </div>
                                    </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($english == "on") { ?>
                            <div class="tab-pane >" id="ingilizce" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Başlık</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control"name="adi_en" placeholder="Lütfen Doldurun" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Açıklama</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="aciklama_en" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($spanish == "on") { ?>
                            <div class="tab-pane >" id="ispanyolca" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" >Açıklama</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="aciklama_es" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($french == "on") { ?>
                            <div class="tab-pane >" id="fransizca" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Açıklama</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="aciklama_fr" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ($arabic == "on") { ?>
                            <div class="tab-pane >" id="arapca" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Açıklama</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="aciklama_ar" rows="6" placeholder="İçerik açıklaması.."> </textarea>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2" style="display: flex;">
                                <label class="css-control css-control-warning css-switch">
                                    ...
                                    <span class="css-control-indicator"></span> Alt Kategori Aktif
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                        <div class="block-options">
                            ...
                            <a href="alt-kategori"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                            </div>
                        </div>
                    </div>
                    </form>
        ...
        if ($perform == "edit") {
            ...
            $getContent = $db->prepare("SELECT * FROM tbl_alt_kategori WHERE id=?");
                        ...
                        <div class="tab-pane active" id="turkce" role="tabpanel">
                            <form action="../operations/controllers/altkategoriController" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label">Açıklama</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="aciklama_tr" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_tr']; ?></textarea>
                                    </div>
                                </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($english == "on") { ?>
                        <div class="tab-pane <?php if ($turkish != "on") { echo  "active"; } ?>" id="ingilizce" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Açıklama</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="aciklama_en" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_en']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($spanish == "on") { ?>
                        <div class="tab-pane " id="ispanyolca" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Açıklama</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="aciklama_es" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_es'] ?></textarea>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($french == "on") { ?>
                        <div class="tab-pane" id="fransizca" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Açıklama</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="aciklama_fr" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_fr'] ?></textarea>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($arabic == "on") { ?>
                        <div class="tab-pane" id="arapca" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label">Açıklama</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="aciklama_ar" rows="6" placeholder="İçerik açıklaması.."><?= $result['aciklama_ar'] ?></textarea>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <select class="form-control" name="kategori_id" required>
                                ...
                                #Sayfa bilgilerini database den çek
                                $getData = $db->prepare("SELECT * FROM tbl_ana_kategori ORDER BY sira ASC");
                                $getData->execute();
