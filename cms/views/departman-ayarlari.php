...
$pageTitle = "Maharethane - Ekip Departman Yönetimi";
$activeClass = "departman";
include('layouts/header.php');
include('../operations/middleware/AuthorizationMiddleware.php');
$perform = $_GET['perform'];
$contentID = $_GET['id'];
$controllerName = "departman";
...
<main id="main-container">
    ...
    <div class="content">
        <div class="block block-transparent bg-video" data-vide-bg="assets/media/videos/city_night" data-vide-options="posterType: jpg" style="position: relative;"><div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-color: transparent; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;"><video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; opacity: 1; width: 1154px; height: auto;"><source src="assets/media/videos/city_night.mp4" type="video/mp4"><source src="assets/media/videos/city_night.webm" type="video/webm"><source src="assets/media/videos/city_night.ogv" type="video/ogg"></video></div>
            <div class="block-content bg-primary-dark-op">
                <div class="py-20 text-center">
                    <h1 class="font-w700 text-white mb-10">Departman Yönetimi</h1>
                    <h2 class="h4 font-w400 text-white-op">Sistemde bulunan yada sistemde bulunacak ekip departmanlarını bu alandan yönetebilirsiniz.</h2>
                </div>
            </div>
        </div>
        ...
        if ($perform == "" or $perform == NULL) { ?>
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">DEPARTMANLAR</h3>
                ...
                <div class="block-content block-content-full">
                    ...
                    <table id="sort" class="table table-bordered table-striped table-vcenter js-dataTable-full background-white">
                        ...
                        <tbody id="sortItems">
                            ...
                            $pageData = $db->prepare("SELECT * FROM tbl_ekip_kategori ORDER BY sira ASC");
                            $pageData->execute();
                                ...
                                <tr data-id="<?= $getData['id']?>">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="../operations/controllers/departmanController?perform=delete&id=<?= $getData["id"]; ?>&adi=<?= $getData["adi_tr"]; ?>" onclick="return confirm('<?= $getData['adi_tr']; ?> Adlı Kaydı Silmek İstediğinize Eminmisiniz? ')">
                ...
                <div class="block-content tab-content">
                    ...
                    <?php if ($turkish == "on") { ?>
                        <div class="tab-pane active" id="turkce" role="tabpanel">
                            <form action="../operations/controllers/departmanController" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" >Departman Adı</label>
                                    <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2" style="display: flex;">
                            <label class="css-control css-control-warning css-switch">
                                ...
                                <span class="css-control-indicator"></span> Departman aktif
                            </label>
                        </div>
                    </div>
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                    <div class="block-options">
                        <div class="block-options-item">
                            ...
                            <a href="departman-ayarlari"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                        </div>
                    </div>
                </div>
                </form>
        ...
        if ($perform == "edit") {
            ...
            $getContent = $db->prepare("SELECT * FROM tbl_ekip_kategori WHERE id=?");
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                    <div class="block-options">
                        <div class="block-options-item">
                            ...
                            <a href="departman-ayarlari?statu=ok"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                        </div>
                    </div>
                </div>
                </form>
