...
<script type="text/javascript">
    ...
    function ajax_file_upload(file_obj) {
        if (file_obj != undefined) {
            ...
            form_data.append('pageName', 'hizmetler');
            form_data.append('performName', 'Hizmetler sayfa yönetimi');
                                ...
                                <tr data-id="<?= $getData['id']?>">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="?perform=foto&id=<?= $getData["id"] ?>&pageName=hizmetler"><button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Galeri" data-placement="bottom">
                ...
                <div class="block">
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm text-right">
                        <div class="block-options">
                            ...
                            <a href="hizmetler"><button type="button" class="btn btn-sm btn-alt-danger"><i class="fa fa-close"></i> İptal</button></a>
                            </div>
                        </div>
                    </div>
                    </form>
                    ...
                    <div class="options-container fx-item-zoom-in fx-overlay-zoom-in" style=" height: 200px; background-image: url(../../uploads/<?= $result["gorsel"] ?>); background-size: cover;">
                        <div class="options-overlay bg-black-op">
                            <div class="options-overlay-content">
                                <a class="btn btn-sm btn-rounded btn-alt-danger min-width-75" href="../operations/controllers/imageUploadController?perform=deleteImage&id=<?= $result["id"]?>&contentID=<?= $result["icerik_id"] ?>&pageName=hizmetler">
