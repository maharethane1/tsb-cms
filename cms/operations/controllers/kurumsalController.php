...
$performName = "Kurumsal Sayfa Yönetimi";
$userName = $_COOKIE['userName'];
$userID = $_COOKIE['userID'];


#Kurumsal sayfa içerik kaydetme
if (isset($_POST['addPage'])) {
    ...
    if ($_FILES['resim']['size']>0) {
        ...
        $benzersizad = $resimadi . "-kurumsal-icerik-" . $benzersizsayi1 . $benzersizsayi2 . $benzersizsayi3 . "." . $uzanti;
        $benzersizad2 = "t1-" . $resimadi . "-kurumsal-icerik-" . $benzersizsayi1 . $benzersizsayi2 . $benzersizsayi3 . "." . $uzanti;
        $benzersizad3 = "t2-" . $resimadi . "-kurumsal-icerik-" . $benzersizsayi1 . $benzersizsayi2 . $benzersizsayi3 . "." . $uzanti;
    ...
    try {
        ...
        if ($savePage) {
            ...
            if ($saveLog) {
                Header("Location: ../../views/kurumsal?statu=ok");
            } else {
                Header("Location: ../../views/kurumsal?statu=logNo");
            }
        } else {

            Header("Location: ../../views/kurumsal?statu=no");
        }
