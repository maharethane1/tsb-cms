...
$performName = "Ana Sayfa Yönetimi";
...
if ( isset($_POST['addPage']) ) { 
    ...
    if ($_FILES['resim']['size']>0) {
        ...
        $benzersizad = $resimadi . "-anasayfa-icerik-" . $benzersizsayi1 . $benzersizsayi2 . $benzersizsayi3 . "." . $uzanti;
        $benzersizad2 = "t1-" . $resimadi . "-anasayfa-icerik-" . $benzersizsayi1 . $benzersizsayi2 . $benzersizsayi3 . "." . $uzanti;
        $benzersizad3 = "t2-" . $resimadi . "-anasayfa-icerik-" . $benzersizsayi1 . $benzersizsayi2 . $benzersizsayi3 . "." . $uzanti;
    ...
    try
    {
        ...
        if ($savePage) {
            ...
            if($saveLog){
                Header("Location: ../../views/ana-sayfa?statu=ok");
            }else{
                Header("Location: ../../views/ana-sayfa?statu=logNo");
            }

            
        } else {

            Header("Location: ../../views/ana-sayfa?statu=no");
        }
